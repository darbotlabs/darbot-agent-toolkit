# Build Office add-ins DA using Microsoft 365 Agents Toolkit
...
| `appPackage` | Templates for the Microsoft 365 Agents application manifest, the GPT manifest and the API specification |
...
| `appPackage/manifest.json`         | Microsoft 365 Agents application manifest that defines metadata for your declarative agent. |
