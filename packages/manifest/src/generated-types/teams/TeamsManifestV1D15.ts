// To parse this data:
//
//   import { Convert, TeamsManifestV1D15 } from "./file";
//
//   const teamsManifestV1D15 = Convert.toTeamsManifestV1D15(json);
//
...
export class Convert {
    public static toTeamsManifestV1D15(json: string): TeamsManifestV1D15 {
        return cast(JSON.parse(json), r("TeamsManifestV1D15"));
    }

    public static teamsManifestV1D15ToJson(value: TeamsManifestV1D15): string {
        return JSON.stringify(uncast(value, r("TeamsManifestV1D15")), null, 4);
    }
}
