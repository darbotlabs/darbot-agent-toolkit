// To parse this data:
//
//   import { Convert, TeamsManifestV1D14 } from "./file";
//
//   const teamsManifestV1D14 = Convert.toTeamsManifestV1D14(json);
//
...
export class Convert {
    public static toTeamsManifestV1D14(json: string): TeamsManifestV1D14 {
        return cast(JSON.parse(json), r("TeamsManifestV1D14"));
    }

    public static teamsManifestV1D14ToJson(value: TeamsManifestV1D14): string {
        return JSON.stringify(uncast(value, r("TeamsManifestV1D14")), null, 4);
    }
}
