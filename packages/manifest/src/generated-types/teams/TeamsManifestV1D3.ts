// To parse this data:
//
//   import { Convert, TeamsManifestV1D3 } from "./file";
//
//   const teamsManifestV1D3 = Convert.toTeamsManifestV1D3(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface TeamsManifestV1D3 {
    $schema?: string;
    /**
...
export type BotScope = "team" | "personal" | "groupChat" | "groupchat";
...
export class Convert {
    public static toTeamsManifestV1D3(json: string): TeamsManifestV1D3 {
        return cast(JSON.parse(json), r("TeamsManifestV1D3"));
    }

    public static teamsManifestV1D3ToJson(value: TeamsManifestV1D3): string {
        return JSON.stringify(uncast(value, r("TeamsManifestV1D3")), null, 4);
    }
}
...
const typeMap: any = {
    ...
    "Bot": o([
        ...
        { json: "scopes", js: "scopes", typ: a(r("BotScope")) },
