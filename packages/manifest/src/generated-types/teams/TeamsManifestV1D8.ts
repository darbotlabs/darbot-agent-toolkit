// To parse this data:
//
//   import { Convert, TeamsManifestV1D8 } from "./file";
//
//   const teamsManifestV1D8 = Convert.toTeamsManifestV1D8(json);
//
...
export class Convert {
    public static toTeamsManifestV1D8(json: string): TeamsManifestV1D8 {
        return cast(JSON.parse(json), r("TeamsManifestV1D8"));
    }

    public static teamsManifestV1D8ToJson(value: TeamsManifestV1D8): string {
        return JSON.stringify(uncast(value, r("TeamsManifestV1D8")), null, 4);
    }
}
