...
[Teams Bot](https://learn.microsoft.com/en-us/microsoftteams/platform/bots/overview) is a great feature that are extensivly customized by broad group of developers. You can create chat bot, notification bot and various bot for different scenarios. And you can evolve Teams bot to [conversational agents for Teams](https://learn.microsoft.com/en-us/microsoftteams/platform/bots/how-to/teams-conversational-ai/ai-ux) with Teams AI library. Agents in Teams can understand and respond to user chat in natural langurage to handle QnA interactions or enagage in commands/actions interacting with bach-end service. 
